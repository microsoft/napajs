...
#define NAPA_SET_PROTOTYPE_PROPERTY(functionTemplate, name, value)                                                     \
    functionTemplate->PrototypeTemplate()->Set(v8::Isolate::GetCurrent(), name, value)
...
#define NAPA_SET_ACCESSOR(functionTemplate, name, getter, setter)                                                      \
    functionTemplate->InstanceTemplate()->SetAccessor(                                                                 \
        v8::String::NewFromUtf8(v8::Isolate::GetCurrent(), name), getter, setter)
...
#define NAPA_SET_PROPERTY(functionTemplate, name, value)                                                               \
    functionTemplate->InstanceTemplate()->Set(v8::Isolate::GetCurrent(), name, value)
...
#else
#define NAPA_DECLARE_PERSISTENT_CONSTRUCTOR static v8::Persistent<v8::Function> _constructor;
#endif
...
#ifdef BUILDING_NAPA_EXTENSION
#define NAPA_SET_PERSISTENT_CONSTRUCTOR(name, function) napa::module::SetPersistentConstructor(name, function)
#else
#define NAPA_SET_PERSISTENT_CONSTRUCTOR(name, function) _constructor.Reset(v8::Isolate::GetCurrent(), function)
#endif
...
#ifdef BUILDING_NAPA_EXTENSION
#define NAPA_GET_PERSISTENT_CONSTRUCTOR(exportName, className) napa::module::GetPersistentConstructor(exportName)
#else
