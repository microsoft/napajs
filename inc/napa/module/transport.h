...
namespace module {
    ...
    struct TransportableObject {
        ...
        static void MarshallCallback(const v8::FunctionCallbackInfo<v8::Value>& args) {
            ...
            v8::Local<v8::Value> argv[argc] = {payload, args[1]};
            saveMethod->Call(
                context, 
                holder,
                argc,
    ...
    namespace transport {
        ...
        /// <param name="transportContextWrap"> TransportContextWrap </param>
        inline v8::MaybeLocal<v8::Value> Marshall(v8::Local<v8::Value> /*object*/, v8::Local<v8::Object> /*transportContextWrap*/) {
            auto isolate = v8::Isolate::GetCurrent();
            // TODO: @dapeng, implement this.
            return v8::Undefined(isolate);
        }

        /// <summary> Unmarshall a payload with transport context. C++ module can use this helper function to unmarshall its members. </summary>
