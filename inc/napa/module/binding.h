...
namespace module {
    namespace binding {
        ...
        /// <summary> Get 'module' object of napa binding, which is napa-binding.node in Node.JS isolate or napa-binding
        /// from core-modules in Napa isolate. </summary>
        ...
        inline v8::MaybeLocal<v8::Object> Require(const char* moduleName) {
            ...
            NAPA_ASSERT(!require.IsEmpty() && require->IsFunction(),
                        "Function \"require\" is not available from module object");

            v8::Local<v8::Value> argv[] = { napa::v8_helpers::MakeV8String(isolate, moduleName) };
            return scope.Escape(napa::v8_helpers::ToLocal<v8::Object>(
        ...
        inline v8::MaybeLocal<v8::Object> NewInstance(const char* wrapType, int argc, v8::Local<v8::Value> argv[]) {
            ...
            return scope.Escape(v8::Local<v8::Function>::Cast(constructor)
        ...
        inline v8::MaybeLocal<v8::Object> NewInstance(const char* moduleName,
            ...
            auto constructor = v8::Local<v8::Function>::Cast(module->Get(v8_helpers::MakeV8String(isolate, className)));
            ...
            return scope.Escape(constructor->NewInstance(context, argc, argv).FromMaybe(v8::Local<v8::Object>()));
        }
        ...
        Call(const char* moduleName, const char* functionName, int argc = 0, v8::Local<v8::Value> argv[] = nullptr) {
