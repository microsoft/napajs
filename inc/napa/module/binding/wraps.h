...
namespace module {
    namespace binding {
        ...
        template <typename T>
        inline v8::Local<v8::Object> CreateShareableWrap(std::shared_ptr<T> object,
                                                         const char* wrapType = "SharedPtrWrap") {
        ...
        CreateAllocatorDebuggerWrap(std::shared_ptr<napa::memory::AllocatorDebugger> allocatorDebugger) {
