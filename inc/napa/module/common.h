...
namespace module {
    ...
    inline void DefaultConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& args) {
        ...
        CHECK_ARG(isolate,
                  args.Length() == 0,
                  "class \"%s\" doesn't accept any arguments in constructor.'",
                  WrapType::exportName);
    ...
    /// 1) static const char* WrapType::exportName must be present as a public member, or add NewInstance as a friend
    /// function.
