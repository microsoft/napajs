...
void MetricWrap::Set(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    InvokeWithDimensions(args,
                         1,
                         [value](napa::providers::Metric* metric, std::vector<const char*>& dimensions) {
...
void MetricWrap::Increment(const v8::FunctionCallbackInfo<v8::Value>& args) {
    InvokeWithDimensions(args,
                         0,
                         [](napa::providers::Metric* metric, std::vector<const char*>& dimensions) {
...
void MetricWrap::InvokeWithDimensions(const v8::FunctionCallbackInfo<v8::Value>& args, uint32_t index, Func&& func) {
    ...
    CHECK_ARG(isolate,
              dimensionsArg->IsArray() || dimensionsArg->IsUndefined(),
              "'dimensions' must be an array or undefined");
