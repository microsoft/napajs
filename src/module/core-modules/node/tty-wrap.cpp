...
void IsTTYCallback(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_ARG(isolate, args.Length() == 1 && args[0]->IsInt32(), "tty_wrap.isTTY requires a file descriptor");
...
void GuessHandleTypeCallback(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_ARG(isolate, args.Length() == 1 && args[0]->IsInt32(), "tty_wrap.getHandleType requires a integer parameter");
