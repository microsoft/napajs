...
void ReadFileSyncCallback(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_ARG(isolate, args.Length() > 0, "fs.readFileSync requires at least 1 argument.");

    CHECK_ARG(isolate, args[0]->IsString(), "fs.readFileSync requires a string of file path as the 1st argument.");
...
void WriteFileSyncCallback(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_ARG(isolate, args.Length() >= 2, "fs.writeFileSync requires 2 parameters.");

    CHECK_ARG(isolate, args[0]->IsString(), "fs.writeFileSync requires a string as the 1st parameter for file name.");

    CHECK_ARG(
        isolate, args[1]->IsString(), "fs.writeFileSync require a string as the 2nd parameter for data to write.");
...
void MkdirSyncCallback(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_ARG(isolate, args.Length() >= 1, "fs.mkdirFileSync requires 1 parameters.");

    CHECK_ARG(
        isolate, args[0]->IsString(), "fs.mkdirFileSync requires a string as the 1st parameter for the directory.");
...
void ExistsSyncCallback(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_ARG(isolate, args.Length() >= 1, "fs.existsSync requires 1 parameters.");

    CHECK_ARG(
        isolate, args[0]->IsString(), "fs.existsSync requires a string as the 1st parameter for the path to check.");
...
void ReaddirSyncCallback(const v8::FunctionCallbackInfo<v8::Value>& args) {
    ...
    CHECK_ARG(isolate, args.Length() >= 1, "fs.readdirSync requires 1 parameters.");

    CHECK_ARG(
        isolate, args[0]->IsString(), "fs.readdirSync requires a string as the 1st parameter for the path to check.");
