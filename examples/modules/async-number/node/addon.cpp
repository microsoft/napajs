...
namespace demo {
    ...
    /// <summary> It increases a number by a given parameter asynchronously and run a callback at the next execution
    /// loop. </summary>
    void Increase(const FunctionCallbackInfo<Value>& args) {
        ...
        napa::zone::PostAsyncWork(Local<Function>::Cast(args[1]),
                                  ...
                                  [](auto jsCallback, void* result) {
                                      ...
                                      int32_t argc = 1;
                                      Local<Value> argv[] = { Integer::NewFromUnsigned(
    ...
    /// <summary> It increases a number by a given parameter synchronously and run a callback at the next execution
    /// loop. </summary>
