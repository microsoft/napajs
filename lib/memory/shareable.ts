...
/// <remarks> The counterpart of Shareable is napa::module::ShareableWrap, always extend napa::module::ShareableWrap for
/// sharable native object. </remarks>
...
export function isShareable(jsValue: any): boolean {
    if (isTransportable(jsValue)) {
        ...
        return object.hasOwnProperty('handle') && object.hasOwnProperty('refCount');
    }
    return false;
}
