...
/// <summary> Store is a facility to share (built-in JavaScript types or Transportable subclasses) objects across
/// isolates. </summary>
export interface Store {
    ...
    /// <param name="key"> Case-sensitive string key. </summary>
    /// <param name="value"> Value. Any value of built-in JavaScript types or Transportable subclasses can be accepted.
    /// </summary>
