...
## Installation
### Prerequisites
\* *If you are using the [supported pre-build platform](https://github.com/Microsoft/napajs/wiki/Supported-pre-build-platforms), the following prerequisites can be ignored.*
